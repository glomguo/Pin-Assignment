...
#  Created on Mon Mar 13 01:18:40 2017                
#                                                     
#######################################################
...
set init_oa_design_cell rockettile_x2_maxrule
...
setTrialRouteMode -maxRouteLayer 8 -minRouteLayer 7
setPinAssignMode -minLayer 7 -maxLayer 8
...
ecoRoute
verifyGeometry -error 10000 -report ../logs/rockettile_x2/innovus_rockettile_x2_maxrule_geometry.rpt
verifyConnectivity -error 10000 -report ../logs/rockettile_x2/innovus_rockettile_x2_maxrule_connectivity.rpt
reportRoute > ../logs/rockettile_x2/innovus_rockettile_x2_maxrule_routeReport.rpt
reportWire ../logs/rockettile_x2/innovus_rockettile_x2_maxrule_wireReport.rpt 0
summaryReport -noHtml -outfile ../logs/rockettile_x2/innovus_rockettile_x2_maxrule_summaryReport.rpt
saveDesign ../outputs/rockettile_x2/rockettile_x2_maxrule.invs
defOut -routing ../outputs/rockettile_x2/rockettile_x2_maxrule.def
streamOut ../outputs/rockettile_x2/rockettile_x2_maxrule.gds -mapFile layer.map -libName DesignLib -units 2000 -mode ALL
